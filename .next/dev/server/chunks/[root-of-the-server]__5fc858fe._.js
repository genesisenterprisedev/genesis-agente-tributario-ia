...
"[project]/services/supabaseClient.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$supabaseClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/supabaseClient.ts [app-route] (ecmascript)");
;
;
async function POST(req) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$supabaseClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].rpc('match_document_chunks', {
        ...
        const enrichedResults = await Promise.all((data || []).map(async (chunk)=>{
            // Buscar informações do documento
            const { data: docData } = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$supabaseClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('documents').select('name, is_deletable').eq('id', chunk.document_id).single();
            return {
                id: chunk.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5fc858fe._.js.map