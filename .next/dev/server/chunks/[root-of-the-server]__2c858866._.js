...
;
;
const resend = ("TURBOPACK compile-time truthy", 1) ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$resend$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Resend"](("TURBOPACK compile-time value", "re_NwRkN5vD_2TWeTo4RhkbGcJUxKButxw3R")) : "TURBOPACK unreachable";
    ...
    try {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                console.error("[API Route] OpenRouter API Error:", response.status, rawErrorText);
                // Tenta extrair mensagem do provider
                let providerMessage = rawErrorText;
                try {
                    const parsed = JSON.parse(rawErrorText);
                    providerMessage = parsed?.error?.message || rawErrorText || "Unknown provider error";
                } catch  {
                // mantém rawErrorText
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2c858866._.js.map